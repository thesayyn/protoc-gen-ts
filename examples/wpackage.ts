...
export namespace my.namespace {
    export class SearchRequest extends pb_1.Message {
        ...
        protected readonly displayName: string = "proto.my.namespace.SearchRequest";
        ...
        get corpus(): my.namespace.SearchRequest.Corpus[] {
            return pb_1.Message.getField(this, 9) as my.namespace.SearchRequest.Corpus[];
        }
        set corpus(value: my.namespace.SearchRequest.Corpus[]) {
        ...
        toObject() {
            return {
                ...
                corpus: (pb_1.Message.getField(this, 9) as my.namespace.SearchRequest.Corpus[])
            };
        }
    ...
    export namespace my.namespace.SearchRequest {
        export class Response extends pb_1.Message {
            protected readonly repeatedFields_: number[] = [9];
            protected readonly displayName: string = "proto.my.namespace.SearchRequest.Response";
            constructor(data?: any[]) {
                super();
                pb_1.Message.initialize(this, data, 0, -1, this.repeatedFields_, null);
            }
