 ...
 * source: test/web/client/src/weather.proto
 * target: web
...
export namespace weather {
    ...
    export class WeatherClient {
        ...
        private static cities = new web_1.MethodDescriptor<CityQuery, CityQuery.Result>("/weather.Weather/cities", web_1.MethodType.UNARY, CityQuery, CityQuery.Result, (message: CityQuery) => message.serialize(), CityQuery.Result.deserialize);
        cities(message: CityQuery, metadata: web_1.Metadata | null, callback: (error: web_1.RpcError, response: CityQuery.Result) => void) {
            return this._client.rpcCall(this._address + "/weather.Weather/cities", message, metadata || {}, WeatherClient.cities, callback);
        }
        private static get = new web_1.MethodDescriptor<GetTemperature, Temperature>("/weather.Weather/get", web_1.MethodType.SERVER_STREAMING, GetTemperature, Temperature, (message: GetTemperature) => message.serialize(), Temperature.deserialize);
