...
import * as imp_1 from "npm:grpc-web";
export class City {
    static type = "City";
    #unknown_fields = [];
    code?: string = "";
    ...
    toJson() {
        const json = {};
        if (this.code !== undefined && this.code !== "") json.code = this.code;
        if (this.name !== undefined && this.name !== "") json.name = this.name;
        return json;
    }
    static fromJson(json: object) {
        ...
        if (code !== null && code !== undefined && code !== "") {
            if (!(typeof code === "string")) throw new Error("illegal value for code");
            message.code = code;
        }
        const name = json.hasOwnProperty("name") ? json.name : json.name;
        if (name !== null && name !== undefined && name !== "") {
            if (!(typeof name === "string")) throw new Error("illegal value for name");
            message.name = name;
        }
        return message;
    }
...
export class Temperature {
    ...
    toJson() {
        const json = {};
        if (this.code !== undefined && this.code !== "") json.code = this.code;
        if (this.current !== undefined && this.current !== 0) json.current = Number.isFinite(this.current) ? this.current : this.current.toString();
        return json;
    }
    static fromJson(json: object) {
        const message = new Temperature;
        ...
        if (current !== null && current !== undefined && current !== 0) {
            if (!((typeof current === "number" || typeof current === "string" && current.indexOf(" ") === -1) && Number.isInteger(+current) && (current === "NaN" || current === "Infinity" || current === "-Infinity" || (current >= -2.147483648e9 && current <= +2.147483647e9)))) throw new Error("illegal value for current");
...
export class CityQuery_Result {
    ...
    toJson() {
        const json = {};
        if (this.cities !== undefined && this.cities.length !== 0) json.cities = this.cities.map((r)=>r.toJson());
        return json;
    }
    static fromJson(json: object) {
        const message = new CityQuery_Result;
        ...
        if (cities !== null && cities !== undefined && cities.length !== 0) {
            message.cities = cities.map((r)=>{
                if (!(typeof r === "object")) throw new Error("illegal value for cities");
...
export class Forecast {
    ...
    toJson() {
        const json = {};
        if (this.code !== undefined && this.code !== "") json.code = this.code;
        if (this.date !== undefined && this.date !== "") json.date = this.date;
        return json;
    }
    static fromJson(json: object) {
        const message = new Forecast;
        ...
        if (date !== null && date !== undefined && date !== "") {
            if (!(typeof date === "string")) throw new Error("illegal value for date");
            message.date = date;
        }
        return message;
    }
...
export class Forecast_Result {
    ...
    toJson() {
        const json = {};
        if (this.temperature !== undefined) json.temperature = this.temperature.toJson();
        return json;
    }
    static fromJson(json: object) {
        const message = new Forecast_Result;
        ...
        if (temperature !== null && temperature !== undefined) {
            if (!(typeof temperature === "object")) throw new Error("illegal value for temperature");
...
export class Weather {
    #url: string;
    #client: imp_1.GrpcWebClientBase;
    constructor(url: string, options?: imp_1.GrpcWebClientBaseOptions){
        this.#url = url;
    ...
    cities(req: CityQuery, metadata?: imp_1.Metadata): Promise<CityQuery_Result> {
    ...
    get(req: GetTemperature, metadata?: imp_1.Metadata): imp_1.ClientReadableStream {
    ...
    ping(req: Ping, metadata?: imp_1.Metadata): never {
    ...
    forecast(req: Forecast, metadata?: imp_1.Metadata): never {
