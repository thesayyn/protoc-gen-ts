...
export class PresenceMessageV3 extends pb_1.Message {
    ...
    toObject() {
        const data: {
            ...
            oneof: this.oneof != null ? this.oneof.toObject() : undefined,
            opt_int32: this.opt_int32,
            opt_enum: this.opt_enum,
            opt_string: this.opt_string,
            opt_message: this.opt_message != null ? this.opt_message.toObject() : undefined,
            opt_oneof: this.opt_oneof != null ? this.opt_oneof.toObject() : undefined,
