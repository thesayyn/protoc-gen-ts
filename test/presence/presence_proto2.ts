...
export class PresenceMessageV2 extends pb_1.Message {
    ...
    toObject() {
        const data: {
            ...
            int32: pb_1.Message.getField(this, 1) != null ? this.int32 : undefined,
            enum: pb_1.Message.getField(this, 2) != null ? this.enum : undefined,
            string: pb_1.Message.getField(this, 3) != null ? this.string : undefined,
            message: pb_1.Message.getField(this, 4) != null ? this.message != null ? this.message.toObject() : undefined : undefined,
            oneof: pb_1.Message.getField(this, 5) != null ? this.oneof != null ? this.oneof.toObject() : undefined : undefined,
            opt_int32: pb_1.Message.getField(this, 6) != null ? this.opt_int32 : undefined,
            opt_enum: pb_1.Message.getField(this, 7) != null ? this.opt_enum : undefined,
            opt_string: pb_1.Message.getField(this, 8) != null ? this.opt_string : undefined,
            opt_message: pb_1.Message.getField(this, 9) != null ? this.opt_message != null ? this.opt_message.toObject() : undefined : undefined,
            opt_oneof: pb_1.Message.getField(this, 10) != null ? this.opt_oneof != null ? this.opt_oneof.toObject() : undefined : undefined,
            repeated: pb_1.Message.getField(this, 11) != null ? this.repeated : undefined,
            map: pb_1.Message.getField(this, 12) != null ? Object.fromEntries(this.map) : undefined
        };
        return data;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (typeof this.opt_string === "string" && this.opt_string.length)
