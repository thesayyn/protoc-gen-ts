...
impl protobuf::Message for FileDescriptorSet {
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.file)?;
                },
                _ => {
...
impl protobuf::Message for FileDescriptorProto {
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    if wire_type != protobuf::wire_format::WireType::LengthDelimited {
                ...
                4 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.message_type)?;
                },
                5 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.enum_type)?;
                },
                6 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.service)?;
                },
                7 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.extension)?;
                },
                8 => {
                    protobuf::rt::read_singular_message_into_field(wire_type, is, &mut self.options)?;
                },
                9 => {
                    protobuf::rt::read_singular_message_into_field(wire_type, is, &mut self.source_code_info)?;
                },
                12 => {
                    if wire_type != protobuf::wire_format::WireType::LengthDelimited {
                        return ::std::result::Result::Err(protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        for value in &self.public_dependency {
            my_size += protobuf::rt::value_size(10, *value, protobuf::wire_format::WireType::Varint);
        };
        for value in &self.weak_dependency {
            my_size += protobuf::rt::value_size(11, *value, protobuf::wire_format::WireType::Varint);
        };
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.field)?;
                },
                6 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.extension)?;
                },
                3 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.nested_type)?;
                },
                4 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.enum_type)?;
                },
                5 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.extension_range)?;
                },
                8 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.oneof_decl)?;
                },
                7 => {
                    protobuf::rt::read_singular_message_into_field(wire_type, is, &mut self.options)?;
                },
                9 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.reserved_range)?;
                },
                10 => {
...
pub mod descriptor_proto {
    ...
    impl protobuf::Message for ExtensionRange {
        ...
        fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::ProtobufResult<()> {
            while !is.eof()? {
                ...
                match field_number {
                    1 => {
                        if wire_type != protobuf::wire_format::WireType::Varint {
                            return ::std::result::Result::Err(protobuf::rt::unexpected_wire_type(wire_type));
                        }
        ...
        fn compute_size(&self) -> u32 {
            ...
            if let Some(v) = self.start {
                my_size += protobuf::rt::value_size(1, v, protobuf::wire_format::WireType::Varint);
            }
            if let Some(v) = self.end {
                my_size += protobuf::rt::value_size(2, v, protobuf::wire_format::WireType::Varint);
            }
            if let Some(v) = self.options.as_ref() {
                let len = v.compute_size();
                my_size += 1 + protobuf::rt::compute_raw_varint32_size(len) + len;
        ...
        fn descriptor_static() -> protobuf::reflect::MessageDescriptor {
            protobuf::reflect::MessageDescriptor::new_generated_2(super::file_descriptor(), 3)
        }
    ...
    impl protobuf::Message for ReservedRange {
        ...
        fn descriptor_static() -> protobuf::reflect::MessageDescriptor {
            protobuf::reflect::MessageDescriptor::new_generated_2(super::file_descriptor(), 4)
        }
...
impl protobuf::Message for ExtensionRangeOptions {
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                999 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.uninterpreted_option)?;
                },
                _ => {
                    protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
impl FieldDescriptorProto {
    ...
    fn generated_message_descriptor_data() -> protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(protobuf::reflect::rt::v2::make_option_enum_accessor::<_, field_descriptor_proto::Label>(
            "label",
            |m: &FieldDescriptorProto| { &m.label },
            |m: &mut FieldDescriptorProto| { &mut m.label },
            field_descriptor_proto::Label::LABEL_OPTIONAL,
        ));
        fields.push(protobuf::reflect::rt::v2::make_option_enum_accessor::<_, field_descriptor_proto::Type>(
            "type",
...
impl protobuf::Message for FieldDescriptorProto {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(v) = self.number {
            my_size += protobuf::rt::value_size(3, v, protobuf::wire_format::WireType::Varint);
        }
        ...
        if let Some(v) = self.oneof_index {
            my_size += protobuf::rt::value_size(9, v, protobuf::wire_format::WireType::Varint);
        }
...
pub mod field_descriptor_proto {
    ...
    impl Type {
        pub(in super) fn generated_enum_descriptor_data() -> protobuf::reflect::GeneratedEnumDescriptorData {
            protobuf::reflect::GeneratedEnumDescriptorData::new_2::<Type>("FieldDescriptorProto.Type", 0)
        }
    }
    ...
    impl Label {
        pub(in super) fn generated_enum_descriptor_data() -> protobuf::reflect::GeneratedEnumDescriptorData {
            protobuf::reflect::GeneratedEnumDescriptorData::new_2::<Label>("FieldDescriptorProto.Label", 1)
        }
    }
}
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.value)?;
                },
                3 => {
                    protobuf::rt::read_singular_message_into_field(wire_type, is, &mut self.options)?;
                },
...
pub mod enum_descriptor_proto {
    ...
    impl protobuf::Message for EnumReservedRange {
        ...
        fn descriptor_static() -> protobuf::reflect::MessageDescriptor {
            protobuf::reflect::MessageDescriptor::new_generated_2(super::file_descriptor(), 9)
        }
    ...
    impl protobuf::Clear for EnumReservedRange {
        fn clear(&mut self) {
            self.start = ::std::option::Option::None;
            self.end = ::std::option::Option::None;
            self.unknown_fields.clear();
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.method)?;
                },
                3 => {
                    protobuf::rt::read_singular_message_into_field(wire_type, is, &mut self.options)?;
                },
...
impl FileOptions {
    ...
    fn generated_message_descriptor_data() -> protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(protobuf::reflect::rt::v2::make_option_enum_accessor::<_, file_options::OptimizeMode>(
            "optimize_for",
...
pub mod file_options {
    ...
    impl OptimizeMode {
        pub(in super) fn generated_enum_descriptor_data() -> protobuf::reflect::GeneratedEnumDescriptorData {
            protobuf::reflect::GeneratedEnumDescriptorData::new_2::<OptimizeMode>("FileOptions.OptimizeMode", 2)
        }
    }
}
...
impl FieldOptions {
    ...
    fn generated_message_descriptor_data() -> protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(protobuf::reflect::rt::v2::make_option_enum_accessor::<_, field_options::CType>(
            "ctype",
        ...
        fields.push(protobuf::reflect::rt::v2::make_option_enum_accessor::<_, field_options::JSType>(
            "jstype",
...
pub mod field_options {
    ...
    impl CType {
        pub(in super) fn generated_enum_descriptor_data() -> protobuf::reflect::GeneratedEnumDescriptorData {
            protobuf::reflect::GeneratedEnumDescriptorData::new_2::<CType>("FieldOptions.CType", 3)
        }
    }
    ...
    impl JSType {
        pub(in super) fn generated_enum_descriptor_data() -> protobuf::reflect::GeneratedEnumDescriptorData {
            protobuf::reflect::GeneratedEnumDescriptorData::new_2::<JSType>("FieldOptions.JSType", 4)
        }
    }
}
...
pub struct MethodOptions {
    ...
    deprecated: ::std::option::Option<bool>,
    idempotency_level: ::std::option::Option<protobuf::ProtobufEnumOrUnknown<method_options::IdempotencyLevel>>,
    ///  The parser stores options it doesn't recognize here. See above.
    pub uninterpreted_option: ::std::vec::Vec<UninterpretedOption>,
    // special fields
    #[cfg_attr(serde, serde(skip))]
...
impl MethodOptions {
    ...
    pub fn set_idempotency_level(&mut self, v: method_options::IdempotencyLevel) {
        self.idempotency_level = ::std::option::Option::Some(protobuf::ProtobufEnumOrUnknown::new(v));
    }
    ...
    fn generated_message_descriptor_data() -> protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(protobuf::reflect::rt::v2::make_option_enum_accessor::<_, method_options::IdempotencyLevel>(
            "idempotency_level",
...
impl protobuf::Message for MethodOptions {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(v) = self.idempotency_level {
            my_size += protobuf::rt::enum_or_unknown_size(34, v);
        }
        for value in &self.uninterpreted_option {
            let len = value.compute_size();
            my_size += 2 + protobuf::rt::compute_raw_varint32_size(len) + len;
    ...
    fn write_to_with_cached_sizes(&self, os: &mut protobuf::CodedOutputStream<'_>) -> protobuf::ProtobufResult<()> {
        ...
        if let Some(v) = self.idempotency_level {
            os.write_enum(34, protobuf::ProtobufEnumOrUnknown::value(&v))?;
        }
        for v in &self.uninterpreted_option {
            protobuf::rt::write_message_field_with_cached_size(999, v, os)?;
        };
...
pub mod method_options {
    ...
    impl protobuf::ProtobufEnum for IdempotencyLevel {
        fn value(&self) -> i32 {
            *self as i32
        }
    ...
    impl protobuf::reflect::ProtobufValue for IdempotencyLevel {
        type RuntimeType = protobuf::reflect::runtime_types::RuntimeTypeEnum<Self>;
    }

    impl IdempotencyLevel {
        pub(in super) fn generated_enum_descriptor_data() -> protobuf::reflect::GeneratedEnumDescriptorData {
            protobuf::reflect::GeneratedEnumDescriptorData::new_2::<IdempotencyLevel>("MethodOptions.IdempotencyLevel", 5)
        }
    }
}
...
impl protobuf::Message for UninterpretedOption {
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                2 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.name)?;
                },
                3 => {
                    if wire_type != protobuf::wire_format::WireType::LengthDelimited {
                        return ::std::result::Result::Err(protobuf::rt::unexpected_wire_type(wire_type));
                ...
                6 => {
                    if wire_type != protobuf::wire_format::WireType::Fixed64 {
                        return ::std::result::Result::Err(protobuf::rt::unexpected_wire_type(wire_type));
                    }
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(v) = self.positive_int_value {
            my_size += protobuf::rt::value_size(4, v, protobuf::wire_format::WireType::Varint);
        }
        if let Some(v) = self.negative_int_value {
            my_size += protobuf::rt::value_size(5, v, protobuf::wire_format::WireType::Varint);
        }
...
pub mod uninterpreted_option {
    ...
    impl protobuf::Message for NamePart {
        ...
        fn descriptor_static() -> protobuf::reflect::MessageDescriptor {
            protobuf::reflect::MessageDescriptor::new_generated_2(super::file_descriptor(), 22)
        }
...
impl protobuf::Message for SourceCodeInfo {
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.location)?;
                },
                _ => {
                    protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
pub mod source_code_info {
    ...
    impl protobuf::Message for Location {
        ...
        fn descriptor_static() -> protobuf::reflect::MessageDescriptor {
            protobuf::reflect::MessageDescriptor::new_generated_2(super::file_descriptor(), 24)
        }
...
impl protobuf::Message for GeneratedCodeInfo {
    ...
    fn merge_from(&mut self, is: &mut protobuf::CodedInputStream<'_>) -> protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    protobuf::rt::read_repeated_message_into_vec(wire_type, is, &mut self.annotation)?;
                },
                _ => {
                    protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
pub mod generated_code_info {
    ...
    impl protobuf::Message for Annotation {
        ...
        fn descriptor_static() -> protobuf::reflect::MessageDescriptor {
            protobuf::reflect::MessageDescriptor::new_generated_2(super::file_descriptor(), 26)
        }
